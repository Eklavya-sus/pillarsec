  ...
  return (
    <div className="py-10 px-4 sm:px-8 md:px-16 lg:px-24 xl:px-32">
      <div className="flex justify-between items-center">
        <h1 className="text-white custom-font text-3xl md:text-5xl font-normal leading-normal">
          DACAPO
        </h1>
        <div className="hidden sm:flex items-center gap-11 text-lg md:text-3xl text-white font-poppins font-semibold leading-normal hover:cursor-pointer">
          <p>Home</p>
          <p>Vetting process</p>
